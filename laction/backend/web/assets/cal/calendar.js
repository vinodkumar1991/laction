			...
			var CalendarApp = function() {
				...
				this.$calendar = $('#calendar'),
					...
					CalendarApp.prototype.onEventClick = function(calEvent,
						...
						form
								.append("<div class='input-group'><input class='form-control' type=text value='"
										+ calEvent.title
					...
					CalendarApp.prototype.onSelect = function(start, end,
						...
						$this.$modal.find('.delete-event').hide().end().find(
								'.save-event').show().end().find('.modal-body')
								.empty().prepend(form).end()
								.find('.save-event').unbind('click').click(
										function() {
											form.submit();
										});
						$this.$modal
								...
								.on(
										...
										function() {
											var title = form.find(
													"input[name='title']")
													.val();
											var beginning = form.find(
													"input[name='beginning']")
													.val();
											var ending = form.find(
													"input[name='ending']")
													.val();
								...
								.on(
										...
										function() {
											...
											if (categoryName !== null
												...
												$this.$extEvents
														.append('<div class="dot-outline external-event text-'
																+ categoryColor
																+ '" data-class="bg-'
																+ categoryColor
