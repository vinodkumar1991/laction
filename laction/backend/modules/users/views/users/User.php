<title><?php echo Yii::t('titles', 'laction.admin').Yii::t('titles', 'users.user'); ?></title>
<div class="wraper container-fluid">
	<div class="page-title">
		<h3 class="title"><?php echo Yii::t('breadcrumb','users.users_heading');?></h3>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a
				href="<?php echo Yii::getAlias('@web').'/dashboard'?>"><i
					class="fa fa-dashboard fa-fw"></i><?php echo Yii::t('breadcrumb','common.home');?></a></li>
			<li class="breadcrumb-item"><a
				href="<?php echo Yii::getAlias('@web').'/users'?>"><?php echo Yii::t('breadcrumb','users.module_name');?></a></li>
			<li class="breadcrumb-item active"><a
				href="<?php echo Yii::getAlias('@web').'/users'?>"><?php echo Yii::t('breadcrumb','users.users');?></a></li>
		</ol>
	</div>
	<div class="row">
		<div class="col-md-12">
