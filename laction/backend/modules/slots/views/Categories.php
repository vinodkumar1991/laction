<title><?php echo Yii::t('titles', 'laction.admin').Yii::t('titles', 'settings.categories'); ?></title>
<div class="wraper container-fluid">
	<div class="page-title">
		<h3 class="title"><?php echo Yii::t('breadcrumb','slots.categories_heading');?></h3>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a
				href="<?php echo Yii::getAlias('@web').'/categories'?>"><?php echo Yii::t('breadcrumb','slots.categories');?></a></li>
		</ol>
	</div>
	<div class="row">
		<div class="col-md-12">
